            ...
            return this.each(function () {
                ...
                if (!data) { //check if event is already assigned
                    ...
                    $(obj).bind('click.YouTubePopup', function () {
                        ...
                        //Format YouTube URL
                        var YouTubeURL = "http://www.youtube.com/v/" + youtubeId + "&rel=0&showsearch=0&autohide=" + options.autohide;
                        ...
                        YouTubeURL += "&hd=" + options.hd + "&showinfo=" + options.showinfo + "&start=" + options.start;
