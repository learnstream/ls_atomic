class Memory < ActiveRecord::Base
  ...
  scope :reviewed_today, joins(:component => {:quizzes => :responses}).merge(Response.where('responses.created_at >= ? AND responses.created_at <= ?', DateTime.now.utc.beginning_of_day, DateTime.now.utc))
